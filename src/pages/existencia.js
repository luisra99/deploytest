...
function Existencia() {
  const [elementosFiltrados, setElementosFiltrados] = useState([
    ...
    {
      id_existencia: 93,
      descripcion: "Cinto con evilla de plata",
      costo: "140",
      precio: "1220",
      comision: "20",
      merma_c: false,
    ...
    {
      id_existencia: 96,
      descripcion: "Dige de sombrero de cobre",
      costo: "10",
      precio: "12",
      comision: "12",
      merma_c: false,
    ...
    {
      id_existencia: 92,
      descripcion: "Cartera con adornos en oro",
      costo: "12",
      precio: "120",
      comision: "12",
      merma_c: false,
  ...
  return (
    <div>
      {productos_existencia.length > 0 ? (
          ...
          {elementosFiltrados.length > 0 ? (
                    ...
                    {elementosFiltrados.map(function (producto) {
                      return (
                        ...
                        >
                          ...
                          >
                            <b>
                              {producto.total > 0 ? "Total: " : "Inexistente"}
                            </b>{" "}
                            {producto.total !== 0 ? producto.total : ""}
                            <br />
                            {producto.total !== 0 && <b>Almacen:</b>}
                            {producto.total !== 0 ? producto.almacen : ""}{" "}
                            <br />
                          ...
                          <td data-title="Local">{producto.nombre}</td>
                            ...
                            <div className="text-center">
                              {producto.total > 0 ? (
                                <>
                                  <button
                                    ...
                                    onClick={() =>
                                      Gestion(producto.id_existencia, 1)
                                    }
                                  >
                              ...
                              <>
                                ...
                                <button
                                  className="btn btn-sm "
                                  onClick={() =>
                                    Gestion(producto.id_existencia, 5)
                                  }
                                >
                                  <MdWarning size={18} />
                                  Borrar
            ...
            <h1
              style={{
                textAlign: "center",
                color: "#2c6975",
                textShadow: "1px 1px 3px rgb(34, 80, 89)",
              }}
            >
              No existen productos con estas características
            </h1>
          )}
        </div>
      ) : (
        ...
        >
          No existen productos registrados por el momento
        </h1>
      )}
    </div>
  );
